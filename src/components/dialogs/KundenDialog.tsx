...
export function KundenDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: KundenDialogProps) {
  ...
  const REQUIRED_FIELDS = ['vorname', 'nachname'] as const;
  ...
  const FIELD_LABELS: Record<string, string> = {"email": "E-Mail-Adresse", "vorname": "Vorname", "nachname": "Nachname", "telefon": "Telefonnummer"};
